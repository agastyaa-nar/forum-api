...
DomainErrorTranslator._directories = {
  ...
  'GET_THREAD_DETAIL_USE_CASE.NOT_CONTAIN_THREAD_ID': new InvariantError(
    'tidak dapat mendapatkan detail thread karena parameter yang dibutuhkan tidak ada',
  ),
  'GET_THREAD_DETAIL_USE_CASE.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat mendapatkan detail thread karena tipe data parameter tidak sesuai',
  ),
  ...
  'DELETE_COMMENT_USE_CASE.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
